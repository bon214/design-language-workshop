...
基本・挨拶・カルタ・Work1・Work2の全5素材で、髪の分け目の白線を黒で塗りつぶしました。上記の再利用用プロンプトも現行仕様に合わせて更新しています。今後も髪に白い分け目を描かないでください。
