...
47ページ（sourceId: 35:1490）のメインキャラクター。Naikiとは別の既存コンセプトキャラクターです。

- 画像: public/concept-character-working.png
- 手法: built-in image_gen による既存画像の編集
- 参照: public/concept-character-thinking.png
- フレームと画像は共通の親要素で時計回りに4度回転。
